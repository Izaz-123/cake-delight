...
const handleWithRetry = async (event) => {
    ...
    for (
        ...
        try {
            ...
            console.error(
                `Analytics attempt ${attempt}/${MAX_ATTEMPTS} failed: ${error.message}`
            );
...
const startOrderConsumer = async () => {
    ...
    console.log(
        `Analytics consumer listening on ${QUEUE}`
    );
    ...
    await channel.consume(
        ...
        async message => {
            ...
            try {
                ...
                console.log(
                    `Analytics received event ${event.eventId} (${event.eventType})`
                );
...
onConnectionClosed(() => {
    ...
    const reconnect = async () => {
        ...
        try {
            ...
            console.error(
                "Analytics consumer reconnect failed:",
                error.message
            );
